"""
Module: 'stat' on micropython-v1.29.0-webassembly-pyscript
"""
...
def filemode(x0) -> Incomplete: ...
def S_ISCHR(x0) -> Incomplete: ...
def S_ISBLK(x0) -> Incomplete: ...
def S_IMODE(x0) -> Incomplete: ...
def S_IFMT(x0) -> Incomplete: ...
def S_ISSOCK(x0) -> Incomplete: ...
def S_ISDIR(x0) -> Incomplete: ...
def S_ISREG(x0) -> Incomplete: ...
def S_ISLNK(x0) -> Incomplete: ...
def S_ISFIFO(x0) -> Incomplete: ...
