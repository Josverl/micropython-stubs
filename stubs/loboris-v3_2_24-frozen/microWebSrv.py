...
class MicroWebSrv:
    ...
    _indexPages = ["index.pyhtml", "index.html", "index.htm", "default.pyhtml", "default.html", "default.htm"]
    ...
    class _response:
        ...
        def WriteResponseError(self, code):
            ...
            return self.WriteResponse(
                code, None, "text/html", "UTF-8", self._errCtnTmpl % {"code": code, "reason": responseCode[0], "message": responseCode[1]}
            )

        # ------------------------------------------------------------------------

        def WriteResponseJSONError(self, code, obj=None):
            return self.WriteResponse(code, None, "application/json", "UTF-8", dumps(obj if obj else {}))
