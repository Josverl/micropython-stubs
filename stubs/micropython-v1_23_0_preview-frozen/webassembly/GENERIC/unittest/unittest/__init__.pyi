...
class SubtestContext:
    msg: Incomplete
    params: Incomplete
    def __init__(self, msg: Incomplete | None = ..., params: Incomplete | None = ...) -> None: ...
...
class TestCase:
    ...
    def subTest(self, msg: Incomplete | None = ..., **params): ...
    def skipTest(self, reason) -> None: ...
    def fail(self, msg: str = ...) -> None: ...
    def assertEqual(self, x, y, msg: str = ...) -> None: ...
    def assertNotEqual(self, x, y, msg: str = ...) -> None: ...
    def assertLessEqual(self, x, y, msg: Incomplete | None = ...) -> None: ...
    def assertGreaterEqual(self, x, y, msg: Incomplete | None = ...) -> None: ...
    def assertAlmostEqual(self, x, y, places: Incomplete | None = ..., msg: str = ..., delta: Incomplete | None = ...) -> None: ...
    def assertNotAlmostEqual(self, x, y, places: Incomplete | None = ..., msg: str = ..., delta: Incomplete | None = ...) -> None: ...
    ...
    def assertRaises(self, exc, func: Incomplete | None = ..., *args, **kwargs): ...
...
def _handle_test_exception(current_test: tuple, test_result: TestResult, exc_info: tuple, verbose: bool = ...): ...
def _run_suite(c, test_result: TestResult, suite_name: str = ...): ...
def main(module: str = ..., testRunner: Incomplete | None = ...): ...
