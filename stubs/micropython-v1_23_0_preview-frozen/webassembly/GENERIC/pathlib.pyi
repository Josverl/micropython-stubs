...
class Path:
    ...
    def absolute(self): ...
    def resolve(self): ...
    def open(self, mode: str = ..., encoding: Incomplete | None = ...): ...
    def exists(self): ...
    def mkdir(self, parents: bool = ..., exist_ok: bool = ...) -> None: ...
    def is_dir(self): ...
    def is_file(self): ...
    def _glob(self, path, pattern, recursive) -> Generator[Incomplete, Incomplete, None]: ...
    ...
    def stat(self): ...
    def read_bytes(self): ...
    def read_text(self, encoding: Incomplete | None = ...): ...
    def rename(self, target) -> None: ...
    def rmdir(self) -> None: ...
    def touch(self, exist_ok: bool = ...) -> None: ...
    def unlink(self, missing_ok: bool = ...) -> None: ...
    def write_bytes(self, data) -> None: ...
    def write_text(self, data, encoding: Incomplete | None = ...) -> None: ...
