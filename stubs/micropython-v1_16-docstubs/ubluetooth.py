"""
Low-level Bluetooth radio functionality. See: https://docs.micropython.org/en/v1.16/library/ubluetooth.html
...
# origin module:: micropython/docs/library/ubluetooth.rst
...
class BLE():
    ...
    def gap_scan(self, duration_ms, interval_us=1280000, window_us=11250, active=False, /) -> Any:
        ...
        """
        ...
    def gap_connect(self, addr_type, addr, scan_duration_ms=2000, /) -> None:
        """
    ...
    def gatts_read(self, value_handle, /) -> Any:
        ...
        """
        ...
    def gatts_write(self, value_handle, data, /) -> None:
        """
