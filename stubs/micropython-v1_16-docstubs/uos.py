"""
basic "operating system" services. See: https://docs.micropython.org/en/v1.16/library/uos.html
...
# origin module:: micropython/docs/library/uos.rst
...
def ilistdir(dir: Optional[Any]) -> Iterator[Tuple]:
    ...
    """
    ...
def listdir(dir: Optional[Any]) -> List[Any]:
    """
