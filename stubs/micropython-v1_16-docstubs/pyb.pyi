...
class SPI:
    ...
    def __init__(self, bus, *args) -> None: ...
    def deinit(self) -> None: ...
    def init(self, mode, baudrate: int = ..., prescaler, *, polarity: int = ..., phase: int = ..., bits: int = ..., firstbit=..., ti: bool = ..., crc: Any | None = ...) -> None: ...
...
class USB_VCP:
    ...
    def irq(self, handler: Any | None = ..., trigger: int = ..., hard: bool = ...) -> None: ...
