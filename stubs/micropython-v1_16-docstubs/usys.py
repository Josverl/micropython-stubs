"""
system specific functions. See: https://docs.micropython.org/en/v1.16/library/usys.html

|see_cpython_module| :mod:`python:sys` https://docs.python.org/3/library/sys.html .
"""

# source version: v1.16
# origin module:: micropython/docs/library/usys.rst
