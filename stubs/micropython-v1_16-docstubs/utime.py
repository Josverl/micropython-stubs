"""
time related functions. See: https://docs.micropython.org/en/v1.16/library/utime.html
...
# origin module:: micropython/docs/library/utime.rst
...
def sleep(seconds) -> Any:
    ...
    """
    ...
def sleep_ms(ms) -> Coroutine[None, None, None]:
    """
