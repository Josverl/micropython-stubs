"""
collection and container types. See: https://docs.micropython.org/en/v1.16/library/ucollections.html
...
# origin module:: micropython/docs/library/ucollections.rst
