"""
Module: 'network' on micropython-v1.29.0-esp32-ESP32_GENERIC_S3
"""
...
class WLAN:
    ...
    BANDWIDTH_80_80: Final[int] = 5
    BANDWIDTH_80: Final[int] = 3
    IF_AP: Final[int] = 1
    SEC_OPEN: Final[int] = 0
    BANDWIDTH_160: Final[int] = 4
    BANDWIDTH_40: Final[int] = 2
    BANDWIDTH_20: Final[int] = 1
    ...
    def csi_read(self, *args, **kwargs) -> Incomplete: ...
    ...
    def csi_enable(self, *args, **kwargs) -> Incomplete: ...
    def csi_dropped(self, *args, **kwargs) -> Incomplete: ...
    def csi_available(self, *args, **kwargs) -> Incomplete: ...
    def csi_disable(self, *args, **kwargs) -> Incomplete: ...
