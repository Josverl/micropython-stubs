...
def mount(
    device: Any, mountpoint: Any, readonly: Any = ..., mkfs: Any = ...
) -> None: ...
...
class CAN:
    ...
    def setfilter(
        self, bank: Any, mode: Any, fifo: Any, params: Any, rtr: Any
    ) -> None: ...
...
class ExtInt:
    def __init__(
        self, pin: machine.Pin.pin, mode: Any, pull: Any, callback: Any
    ) -> None: ...
    def regs(cls) -> None: ...
...
class I2C:
    ...
    def deinit(self) -> None: ...
    def init(
        self, mode: Any, addr: Any = ..., baudrate: smallint = ..., gencall: Any = ...
    ) -> None: ...
...
class Servo:
    ...
    def calibration(
        ...
        pulse_min: smallint,
        pulse_max: smallint,
        pulse_centre: smallint,
        pulse_angle_90: smallint,
        pulse_speed_100: smallint,
    ) -> None: ...
...
class UART:
    ...
    def init(
        ...
        timeout: Any = ...,
        flow: Any = ...,
        timeout_char: smallint = ...,
        read_buf_len: smallint = ...,
    ) -> None: ...
    def deinit(self) -> None: ...
    def any(self) -> None: ...
