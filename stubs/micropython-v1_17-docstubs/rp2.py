"""
functionality specific to the RP2. See: https://docs.micropython.org/en/v1.17/library/rp2.html
...
class StateMachine():
    ...
    def irq(self, handler=None, trigger=0|1, hard=False) -> Any:
        ...
        """
        ...
def asm_pio(*, out_init=None, set_init=None, sideset_init=None, in_shiftdir=0, out_shiftdir=0, autopush=False, autopull=False, push_thresh=32, pull_thresh=32, fifo_join=PIO.JOIN_NONE) -> Any:
    """
