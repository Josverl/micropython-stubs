"""
Module: 'flashbdev' on micropython-v1.20.0-esp32-GENERIC_OTA
"""
...
bdev: Any  ## <class 'Partition'> = <Partition type=1, subtype=129, address=3211264, size=983040, label=vfs, encrypted=0>
