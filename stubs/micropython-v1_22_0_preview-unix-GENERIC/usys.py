"""
Module: 'usys' on micropython-v1.22.0.preview-unix-linux_[GCC_9.4.0]_version
"""
...
version = "3.4.0; MicroPython v1.22.0-preview.208.gb5449b0f0 on 2023-12-05"  # type: str
ps1 = ">>> "  # type: str
ps2 = "... "  # type: str
