"""
functions related to the board. See: https://docs.micropython.org/en/v1.15/library/pyb.html
...
class Pin():
    ...
    def mapper(cls, fun: Optional[Any]) -> Any:
        ...
        """
        ...
    def init(self, mode, pull=PULL_NONE, af=-1) -> None:
        """
           Initialise the pin:
...
class SPI():
    ...
    def deinit(self) -> None:
        ...
        """
        ...
    def init(self, mode, baudrate=328125, *, prescaler, polarity=1, phase=0, bits=8, firstbit=MSB, ti=False, crc=None) -> None:
        """
