...
MicroPython module: https://docs.micropython.org/en/v1.22.0/library/machine.html
...
---
Module: 'umachine' on micropython-v1.22.0-rp2-ARDUINO_NANO_RP2040_CONNECT
"""
...
class Pin:
    ...
    class cpu:
        ...
        GPIO2: Incomplete  ## <class 'Pin'> = Pin(GPIO2, mode=IN, pull=PULL_DOWN)
        ...
        GPIO8: Incomplete  ## <class 'Pin'> = Pin(GPIO8, mode=ALT, pull=PULL_DOWN, alt=SPI)
        ...
        GPIO3: Incomplete  ## <class 'Pin'> = Pin(GPIO3, mode=OUT, pull=PULL_DOWN)
        GPIO9: Incomplete  ## <class 'Pin'> = Pin(GPIO9, mode=OUT, pull=PULL_DOWN)
        EXT_GPIO4: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO4, mode=IN)
        EXT_GPIO5: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO5, mode=IN)
        EXT_GPIO6: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO6, mode=IN)
        ...
        EXT_GPIO3: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO3, mode=IN)
        ...
        GPIO14: Incomplete  ## <class 'Pin'> = Pin(GPIO14, mode=ALT, pull=PULL_DOWN, alt=SPI)
        ...
        GPIO10: Incomplete  ## <class 'Pin'> = Pin(GPIO10, mode=IN, pull=PULL_DOWN)
        GPIO11: Incomplete  ## <class 'Pin'> = Pin(GPIO11, mode=ALT, pull=PULL_DOWN, alt=SPI)
    ...
    class board:
        TX: Incomplete  ## <class 'Pin'> = Pin(GPIO0, mode=ALT, pull=PULL_DOWN, alt=31)
        D6: Incomplete  ## <class 'Pin'> = Pin(GPIO18, mode=ALT, pull=PULL_DOWN, alt=31)
        D7: Incomplete  ## <class 'Pin'> = Pin(GPIO19, mode=ALT, pull=PULL_DOWN, alt=31)
        D8: Incomplete  ## <class 'Pin'> = Pin(GPIO20, mode=ALT, pull=PULL_DOWN, alt=31)
        D5: Incomplete  ## <class 'Pin'> = Pin(GPIO17, mode=ALT, pull=PULL_DOWN, alt=31)
        D21: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO6, mode=IN)
        D3: Incomplete  ## <class 'Pin'> = Pin(GPIO15, mode=ALT, pull=PULL_DOWN, alt=31)
        D4: Incomplete  ## <class 'Pin'> = Pin(GPIO16, mode=ALT, pull=PULL_DOWN, alt=31)
        D9: Incomplete  ## <class 'Pin'> = Pin(GPIO21, mode=ALT, pull=PULL_DOWN, alt=31)
        RX: Incomplete  ## <class 'Pin'> = Pin(GPIO1, mode=ALT, pull=PULL_DOWN, alt=31)
        SCL: Incomplete  ## <class 'Pin'> = Pin(GPIO13, mode=ALT, pull=PULL_DOWN, alt=31)
        SDA: Incomplete  ## <class 'Pin'> = Pin(GPIO12, mode=ALT, pull=PULL_DOWN, alt=31)
        LED_RED: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO0, mode=IN)
        LED: Incomplete  ## <class 'Pin'> = Pin(GPIO6, mode=ALT, pull=PULL_DOWN, alt=31)
        LED_BLUE: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO2, mode=IN)
        LED_GREEN: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO1, mode=IN)
        D20: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO5, mode=IN)
        A4: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO3, mode=IN)
        A5: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO4, mode=IN)
        A6: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO5, mode=IN)
        A3: Incomplete  ## <class 'Pin'> = Pin(GPIO29, mode=ALT, pull=PULL_DOWN, alt=31)
        A0: Incomplete  ## <class 'Pin'> = Pin(GPIO26, mode=ALT, pull=PULL_DOWN, alt=31)
        A1: Incomplete  ## <class 'Pin'> = Pin(GPIO27, mode=ALT, pull=PULL_DOWN, alt=31)
        A2: Incomplete  ## <class 'Pin'> = Pin(GPIO28, mode=ALT, pull=PULL_DOWN, alt=31)
        A7: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO6, mode=IN)
        D18: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO3, mode=IN)
        D19: Incomplete  ## <class 'Pin'> = Pin(EXT_GPIO4, mode=IN)
        D2: Incomplete  ## <class 'Pin'> = Pin(GPIO25, mode=ALT, pull=PULL_DOWN, alt=31)
        D13: Incomplete  ## <class 'Pin'> = Pin(GPIO6, mode=ALT, pull=PULL_DOWN, alt=31)
        D10: Incomplete  ## <class 'Pin'> = Pin(GPIO5, mode=ALT, pull=PULL_DOWN, alt=31)
        D11: Incomplete  ## <class 'Pin'> = Pin(GPIO7, mode=ALT, pull=PULL_DOWN, alt=31)
        D12: Incomplete  ## <class 'Pin'> = Pin(GPIO4, mode=ALT, pull=PULL_DOWN, alt=31)
