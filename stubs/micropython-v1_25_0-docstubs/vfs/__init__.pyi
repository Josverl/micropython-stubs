...
class VfsLfs1():
    ...
    """
    def __init__(self, block_dev: AbstractBlockDev, readsize=32, progsize=32, lookahead=32
    ) -> None:
        ...
    @staticmethod
...
class VfsLfs2():
    ...
    See :ref:`filesystem` for more information.
    """
    def __init__(self, block_dev: AbstractBlockDev, readsize=32, progsize=32, lookahead=32, mtime=True
    ) -> None:
        ...
    @staticmethod
    def mkfs(block_dev: AbstractBlockDev, readsize=32, progsize=32, lookahead=32) -> None:
