...
class CC3K:
    ...
    def connect(self, ssid, key: Incomplete | None = ..., *, security=..., bssid: Incomplete | None = ...) -> None:
        """
        Connect to a WiFi access point using the given SSID, and other security
        parameters.
        """
    ...
    def ifconfig(self) -> Tuple:
        ...
        MAC address, SSID).
        """
    def patch_version(self) -> Incomplete:
        """
        Return the version of the patch program (firmware) on the CC3000.
        """
    def patch_program(self, cmd: str) -> Incomplete:
        """
...
class LAN:
    ...
    def __init__(self, id, *, phy_type: int = ..., phy_addr: int = ..., phy_clock: int = ...) -> None: ...
