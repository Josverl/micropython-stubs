...
class Pin:
    ...
    IRQ_HIGH_LEVEL: Any
    def __init__(
        self, id, mode: int = ..., pull: int = ..., *, value: Any | None = ..., drive: Any | None = ..., alt: Any | None = ...
    ) -> None: ...
    def init(
        self, mode: int = ..., pull: int = ..., *, value: Any | None = ..., drive: Any | None = ..., alt: Any | None = ...
    ) -> None: ...
    ...
    def off(self) -> None: ...
    def irq(
        self, handler: Any | None = ..., trigger=..., *, priority: int = ..., wake: Any | None = ..., hard: bool = ...
    ) -> Callable[..., Any]: ...
    def low(self) -> None: ...
    def high(self) -> None: ...
