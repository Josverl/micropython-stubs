...
class Pin:
    ...
    IRQ_LOW_LEVEL: Any
    IRQ_HIGH_LEVEL: Any
    def __init__(self, id, mode: int = ..., pull: int = ..., *, value: Any | None = ..., drive: Any | None = ..., alt: Any | None = ...) -> None: ...
    def init(self, mode: int = ..., pull: int = ..., *, value: Any | None = ..., drive: Any | None = ..., alt: Any | None = ...) -> None: ...
