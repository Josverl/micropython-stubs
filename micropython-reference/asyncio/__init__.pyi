...
from abc import ABC
from typing import (Any, Awaitable, Callable, Coroutine, Dict, Generic,
                    Iterable, List, Tuple)
...
def wait_for(awaitable: Awaitable[_T], timeout: float, /) -> Coroutine[Incomplete, Any, Any]:
    """
...
def gather(*awaitable: Awaitable[Any], return_exceptions: bool = False) -> Coroutine[List, Any, Any]:
    """
