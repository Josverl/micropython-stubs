...
class TestExampleQueries:
    ...
    def test_example_queries_imports(self):
        ...
        spec = importlib.util.spec_from_file_location("example_queries", Path(__file__).parent / "example_queries.py")
...
class TestCheckSchema:
    ...
    def test_check_schema_imports(self):
        ...
        spec = importlib.util.spec_from_file_location("check_schema", Path(__file__).parent / "check_schema.py")
        module = importlib.util.module_from_spec(spec)
        assert module is not None
...
class TestRunLocal:
    ...
    def test_run_local_imports(self):
        ...
        spec = importlib.util.spec_from_file_location("run_local", Path(__file__).parent / "run_local.py")
        module = importlib.util.module_from_spec(spec)
        assert module is not None
