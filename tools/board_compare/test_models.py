...
class TestMethod:
    ...
    def test_method_with_docstring(self):
        ...
        method = Method(name="test_func", docstring="This is a test function.\nIt does something.")
...
class TestClass:
    ...
    def test_create_class_with_attributes(self):
        ...
        cls = Class(name="TestClass", attributes=attrs, docstring=None)
    ...
    def test_class_with_docstring(self):
        ...
        cls = Class(name="TestClass", docstring="This is a test class.\nIt represents something.")
...
class TestModule:
    ...
    def test_create_module_with_classes(self):
        ...
        classes = [Class(name="Class1"), Class(name="Class2")]
    ...
    def test_create_module_with_functions(self):
        ...
        functions = [Method(name="func1"), Method(name="func2", parameters=[Parameter(name="x")])]
    ...
    def test_create_module_with_constants(self):
        ...
        module = Module(name="test_module", constants=constants, docstring=None)
    ...
    def test_complex_module(self):
        ...
        class_methods = [
            Method(
                name="__init__",
                parameters=[Parameter(name="self", type_hint=None, default_value=None, is_optional=False, is_variadic=False)],
                return_type=None,
                is_async=False,
        ...
        # Create a class
        test_class = Class(name="Processor", methods=class_methods, docstring="A data processor class.")

        # Create module-level functions
        module_functions = [
            Method(
                name="helper",
                parameters=[Parameter(name="x", type_hint="int", default_value=None, is_optional=False, is_variadic=False)],
                return_type="str",
                is_async=False,
                is_classmethod=False,
                is_staticmethod=False,
        ...
        # Create module
        module = Module(
            name="processing", classes=[test_class], functions=module_functions, constants=constants, docstring="Data processing module."
        )
...
class TestBoard:
    ...
    def test_create_simple_board(self):
        ...
        board = Board(version="v1.26.0", port="esp32", board="esp32_generic", modules=[])
    ...
    def test_create_board_with_modules(self):
        ...
        modules = [Module(name="machine"), Module(name="time"), Module(name="gc")]
        board = Board(version="v1.26.0", port="esp32", board="esp32_generic", modules=modules)
    ...
    def test_board_serialization(self):
        ...
        module = Module(name="test", functions=[Method(name="func1")])
        board = Board(version="v1.26.0", port="test", board="test_board", modules=[module])
