...
---
Module: 'machine' on micropython-v1.29.0-rp2-WAVESHARE_RP2040_ZERO
"""

# MCU: {'mpy': 'v6.3', 'build': '', 'ver': '1.29.0', 'arch': 'armv6m', 'version': '1.29.0', 'port': 'rp2', 'board': 'WAVESHARE_RP2040_ZERO', 'family': 'micropython', 'board_id': 'WAVESHARE_RP2040_ZERO', 'variant': '', 'cpu': 'RP2040'}
# Stubber: v1.28.6
...
class USBDevice:
    ...
    class BUILTIN_CDC:
        ...
        itf_max: int = 2
        str_max: int = 5
        desc_dev: bytes = b"\x12\x01\x00\x02\xef\x02\x01@\x8a.\x1f\x10\x00\x01\x01\x02\x03\x01"
...
class Pin:
    ...
    class board:
        NEOPIXEL: Pin  ## = Pin(GPIO16, mode=ALT, pull=PULL_DOWN, alt=31)
        def __init__(self, *argv, **kwargs) -> None: ...
