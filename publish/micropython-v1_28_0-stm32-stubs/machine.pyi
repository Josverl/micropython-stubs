...
---
Module: 'machine' on micropython-v1.28.0-stm32-PYBV11-NETWORK
"""
...
class CAN:
    ...
    MODE_SILENT_LOOPBACK: Final[int] = 4
    """\
    ...
    """
    IRQ_TX_IDX_SHIFT: Final[int] = 16
    """Additional IRQ event flags for `CAN.IRQ_TX`. See `machine_can_irq_flags`."""
    IRQ_TX_FAILED: Final[int] = 4
    """Additional IRQ event flags for `CAN.IRQ_TX`. See `machine_can_irq_flags`."""
    IRQ_TX_IDX_MASK: Final[int] = 255
    """Additional IRQ event flags for `CAN.IRQ_TX`. See `machine_can_irq_flags`."""
    IRQ_RX: Final[int] = 2
