...
Included stubs:
* Merged stubs from `stubs/micropython-v1_22_0-rp2-RPI_PICO_W-merged`
* Frozen stubs from `stubs/micropython-v1_22_0-frozen/rp2/RPI_PICO_W`
