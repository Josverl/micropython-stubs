...
Included stubs:
* Merged stubs from `stubs/micropython-v1_24_0_preview-rp2-RPI_PICO_W-merged`
* Frozen stubs from `stubs/micropython-v1_24_0_preview-frozen/rp2/RPI_PICO_W`
...
Core | micropython | rp2 | - | v1.24.0-preview 
