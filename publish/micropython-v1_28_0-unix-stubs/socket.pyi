...
---
Module: 'socket' on micropython-v1.28.0-unix-standard
"""
...
from typing import Literal, Tuple, overload, Any, Final, Generator, AsyncGenerator
...
AF_INET: Final[int] = 2
"""Address family types. Availability depends on a particular :term:`MicroPython port`."""
IP_ADD_MEMBERSHIP: Final[int] = 35
MSG_DONTWAIT: Final[int] = 64
MSG_DONTROUTE: Final[int] = 4
IP_DROP_MEMBERSHIP: Final[int] = 36
