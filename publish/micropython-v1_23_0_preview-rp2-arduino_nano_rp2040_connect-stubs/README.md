...
Included stubs:
* Merged stubs from `stubs/micropython-v1_23_0_preview-rp2-ARDUINO_NANO_RP2040_CONNECT-merged`
* Frozen stubs from `stubs/micropython-v1_23_0_preview-frozen/rp2/ARDUINO_NANO_RP2040_CONNECT`
...
Core | micropython | rp2 | - | v1.23.0-preview 
