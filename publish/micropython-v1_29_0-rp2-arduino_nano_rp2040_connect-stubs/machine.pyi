...
---
Module: 'machine' on micropython-v1.29.0-rp2-ARDUINO_NANO_RP2040_CONNECT
"""

# MCU: {'mpy': 'v6.3', 'build': '', 'ver': '1.29.0', 'arch': 'armv6m', 'version': '1.29.0', 'port': 'rp2', 'board': 'ARDUINO_NANO_RP2040_CONNECT', 'family': 'micropython', 'board_id': 'ARDUINO_NANO_RP2040_CONNECT', 'variant': '', 'cpu': 'RP2040'}
# Stubber: v1.28.6
...
class USBDevice:
    ...
    class BUILTIN_CDC_MSC:
        ...
        desc_cfg: bytes = b"\t\x02b\x00\x03\x01\x00\x80}\x08\x0b\x00\x02\x02\x02\x00\x00\t\x04\x00\x00\x01\x02\x02\x00\x04\x05$\x00 \x01\x05$\x01\x00\x01\x04$\x02\x06\x05$\x06\x00\x01\x07\x05\x81\x03\x08\x00\x01\t\x04\x01\x00\x02\n\x00\x00\x00\x07\x05\x02\x02@\x00\x00\x07\x05\x82\x02@\x00\x00\t\x04\x02\x00\x02\x08\x06P\x05\x07\x05\x03\x02@\x00\x00\x07\x05\x83\x02@\x00\x00"
