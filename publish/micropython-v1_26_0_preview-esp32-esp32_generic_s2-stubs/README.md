...
Included stubs:
* Merged stubs from `stubs/micropython-v1_26_0_preview-esp32-ESP32_GENERIC_S2-merged`
* Frozen stubs from `stubs/micropython-v1_26_0_preview-frozen/esp32/GENERIC`
