# micropython-nrf-seeed_xiao_nrf52-stubs
...
Included stubs:
* Merged stubs from `stubs/micropython-v1_29_0-nrf-SEEED_XIAO_NRF52-merged`
* Frozen stubs from `stubs/micropython-v1_29_0-frozen/nrf/GENERIC`
